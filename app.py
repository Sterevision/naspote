...
def api_telegram_auth():
    ...
    # ИСПРАВЛЕНИЕ: fake_email и fake_password определены ДО if/else
    ...
    if existing.data:
        ...
        profile_data = {
            ...
            "account_type": "person", "telegram_id": tg_id
        }
        if tg_photo_url:
    ...
    try:
        sb_admin.auth.admin.update_user_by_id(uid, {"password": fake_password})
...
def api_spots_create():
    ...
    data = {
        "owner_id": uid, "title": title, "description": description,
